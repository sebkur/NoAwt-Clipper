...
/**
 * This provides some alternative implementations of a few methods from the Math
 * class.
 * <P>
 * This class may use approximations with various levels of error. The "G" in
 * the name stands for "Graphics", because it was originally conceived as a tool
 * to speed up graphics. When I iterate over every pixel in an image to perform
 * some operation: I don't really need the precision that the Math class offers.
 * <P>
...
public abstract class MathG
{
	...
	/**
	 * Finds the closest integer that is less than or equal to the argument as a
	 * double. <BR>
	...
	/**
	 * Finds the closest integer that is less than or equal to the argument as
	 * an int. <BR>
	 * Warning: do not use an argument greater than 1e10, or less than 1e-10.
	 */
	...
	/**
	 * Rounds a double to the nearest integer value. <BR>
	 * Warning: do not use an argument greater than 1e10, or less than 1e-10.
	 */
	...
	/**
	 * Finds the closest integer that is greater than or equal to the argument
	 * as an int. <BR>
	 * Warning: do not use an argument greater than 1e10, or less than 1e-10.
	 */
